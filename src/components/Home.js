...
const MiniGameContainer = tw.div`h-screen w-full bg-gray-800`;
const Wrapper = tw.div`h-full w-full max-w-6xl mx-auto flex flex-col justify-center items-center`
const Canvas = tw.canvas`w-4/5 mt-24`
